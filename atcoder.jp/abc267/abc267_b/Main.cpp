...
struct Solver {
    void solve() {
        ...
        if(S[0] == '1') println("No");
        if(S[4] == '0')
            if(S[1] == '1' || S[3] == '1' || S[6] == '1' || S[7] == '1')
                if(S[2] == '1' || S[5] == '1' || S[8] == '1' || S[9] == '1') println("Yes");
        if(S[1] == '0' && S[7] == '0')
            if(S[3] == '1' || S[6] == '1')
                if(S[2] == '1' || S[4] == '1' || S[5] == '1' || S[8] == '1' || S[9] == '1') println("Yes");
        if(S[2] == '0' && S[8] == '0')
            if(S[5] == '1' || S[9] == '1')
                if(S[1] == '1' || S[3] == '1' || S[4] == '1' || S[6] == '1' || S[7] == '1') println("Yes");
        if(S[3] == '0')
            if(S[6] == '1')
                if(S[1] == '1' || S[2] == '1' || S[4] == '1' || S[5] == '1' || S[7] == '1' || S[8] == '1' || S[9] == '1') println("Yes");
        if(S[5] == '0')
            if(S[9] == '1')
                if(S[1] == '1' || S[2] == '1' || S[3] == '1' || S[4] == '1' || S[6] == '1' || S[7] == '1' || S[8] == '1') println("Yes");
        print("No");
    }
};
